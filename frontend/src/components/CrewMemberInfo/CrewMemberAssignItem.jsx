import BtnAssignMember from '../AssignMember/BtnAssignMember';
function CrewMemberAssignItem({ flight, crewId, flightId, onSave }) {
  ...
  return (
    <li className="flightTableForCrew__item">
      ...
      <button className="addCrew__item__midCol__btn" onClick={onSave}>
        <svg
...
export default CrewMemberAssignItem;
